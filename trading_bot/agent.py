...
def huber_loss(y_true, y_pred, clip_delta=1.0):
    ...
    quadratic_loss = 0.5 * tf.math.square(clip_delta) + clip_delta * (tf.math.abs(error) - clip_delta)
...
class Agent:
    ...
    def _model(self):
        ...
        """
        model = Sequential()
        model.add(Dense(units=20, activation="relu", input_dim=self.state_size))
